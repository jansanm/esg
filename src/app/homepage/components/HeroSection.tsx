        ...
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-12 items-center min-h-[500px]">
            ...
            <div className="space-y-8 z-10 w-full text-left">
                <div className="transition-all duration-500 ease-in-out">
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight tracking-tight text-emerald-700 mb-6">
                        {card.headline}
                    </h1>
                             ...
                             {cards.map((_, index) => (
                                <button
                                    ...
                                    className={`w-3 h-3 rounded-full transition-all duration-300 border border-emerald-600 ${
                                        index === activeCard ? 'bg-emerald-600 scale-125' : 'bg-transparent hover:bg-emerald-100'
                                    }`}
