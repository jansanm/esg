  ...
  return (
    <div className="absolute top-full left-0 w-full bg-white border-t-2 border-green-700 shadow-2xl animate-in fade-in slide-in-from-top-2 duration-300 z-50">
      <div className="max-w-7xl mx-auto flex min-h-[400px]">
        ...
        <div className="w-1/3 p-10 border-r border-gray-200 bg-gradient-to-b from-green-50 to-white">
          <div className="h-full flex flex-col justify-between">
            <div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">The All-in-One <br/> <span className="text-green-700">ESG Platform</span></h3>
              ...
              <div className="space-y-3 mb-8">
                ...
                >
                  <Icon name="ShieldCheckIcon" size={18} className="text-green-600 group-hover:text-green-700" />
                ...
                <Link 
                  ...
                  className="flex items-center gap-2 text-gray-700 hover:text-green-700 transition-colors group"
                >
                  <Icon name="BuildingOfficeIcon" size={18} className="text-green-600 group-hover:text-green-700" />
                  <span className="font-medium">Facilities Management</span>
                </Link>
                <Link 
                  href="/platform-overview" 
                  className="flex items-center gap-2 text-gray-700 hover:text-green-700 transition-colors group"
                >
                  <Icon name="ChartBarIcon" size={18} className="text-green-600 group-hover:text-green-700" />
              ...
              <Link 
                href="/platform-overview" 
                className="inline-flex items-center px-6 py-3 text-sm font-semibold text-white bg-green-700 hover:bg-green-800 hover:shadow-lg hover:-translate-y-0.5 rounded-lg transition-all duration-200"
              >
                Explore Platform
        ...
        <div className="w-2/3 p-10">
          <div className="grid grid-cols-2 gap-6">
            {platform.map((item) => (
              <Link 
                key={item.title} 
                href={item.href}
                className="group p-4 rounded-xl border border-gray-200 hover:border-green-700 hover:bg-green-50 transition-all duration-200 hover:shadow-md"
              >
          ...
          <div className="mt-8 pt-6 border-t border-gray-200 flex justify-between items-center">
             ...
             <Link href="/solutions-hub" className="text-sm font-medium text-green-700 hover:text-green-800 flex items-center gap-1 transition-colors">
